    ...
    const fetchWeatherData = async () => {
      ...
      try {
        ...
        const weatherInfo = {
          ...
          wave: 'N/A', // API에서 제공되지 않음
          temp: `${data.result.data[0].water_temp} °C`, // 기온
          day1_am_status: 'N/A', // API에서 제공되지 않음
          day1_pm_status: 'N/A', // API에서 제공되지 않음
          day2_am_status: 'N/A', // API에서 제공되지 않음
          day2_pm_status: 'N/A', // API에서 제공되지 않음
          day3_am_status: 'N/A', // API에서 제공되지 않음
          day3_pm_status: 'N/A', // API에서 제공되지 않음
          beach_name: data.result.meta.beach_name // 해변 이름
        };
